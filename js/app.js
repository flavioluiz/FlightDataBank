...
function updateCharts() {
    ...
    console.log('Updating charts for page:', pageId);
...
function setupEventListeners() {
    ...
    const controls = [
        { element: document.getElementById('x-axis-select'), callback: updateScatterChart },
        { element: document.getElementById('y-axis-select'), callback: updateScatterChart },
        { element: document.getElementById('timeline-param'), callback: updateTimelineChart },
        { element: document.getElementById('timeline-log-scale'), callback: updateTimelineChart }
    ];
